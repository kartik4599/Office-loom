...
const WorkspaceSidebar = () => {
  ...
  if (workspaceLoading || memberLoading) {
    return (
      <div className="flex flex-col bg-[#8199c3] h-full items-center justify-center">
  ...
  if (!member || !workspace) {
    return (
      <div className="flex flex-col gap-y-2 bg-[#8199c3] h-full items-center justify-center">
  ...
  return (
    <div className="flex flex-col bg-[#8199c3] h-full">
      <WorkspaceHeader
        workspace={workspace}
