  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="size-9 relative overflow-hidden bg-[#84B19E] hover:bg-[#84B19E]/80 text-slate-800 font-semibold">
          {currentLoading ? (
      ...
      <DropdownMenuContent side="bottom" align="start" className="w-64">
        ...
        {otherWorkSpaces?.map((workspace) => (
          <DropdownMenuItem
            ...
            <div className="shrink-0 size-9 relative overflow-hidden bg-[#84B19E] text-white font-semibold text-lg rounded-md flex items-center justify-center mr-2">
